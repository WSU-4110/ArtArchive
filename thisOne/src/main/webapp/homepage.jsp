...
<div class="d-flex flex-column">
        <div class="p-2">
            ...
            <img src = "https://images.unsplash.com/photo-1593642633279-1796119d5482?ixid=MXwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80"style="width:500px;height:600px;">
        ...
        <div class="p-2"><h2>An Introduction to Lynette Yiadom-Boakye</h2>
            <h3>Learn about the lives of artists and the stories behind their work
            </h3>
            <img src = "https://images.unsplash.com/photo-1606998768480-e27b7995b2be?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80"style="width:500px;height:600px;" >
        ...
        <div class="p-2">    <h2>Discover Art </h2>
            <h3>Abstract art is art that does not attempt to represent an accurate depiction of a visual reality but instead use shapes, colours, forms and gestural marks to achieve its effectead use shapes, colours, forms and gestural marks to achieve its effect
            </h3>
            <img src = "https://images.unsplash.com/photo-1604864708171-b6a408b4cba2?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=676&q=80" style="width:500px;height:600px;">
